 ...
 * Use the {@link HoldFragment#newInstance} factory method to
...
public class HoldFragment extends Fragment {
     ...
     * @return A new instance of fragment HoldFragment.
     */
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.button2).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(HoldFragment.this)
                        .navigate(R.id.action_holdFragment_to_FirstFragment);
            }
